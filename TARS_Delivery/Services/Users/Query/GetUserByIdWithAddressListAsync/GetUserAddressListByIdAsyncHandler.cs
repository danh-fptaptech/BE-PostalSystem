...
internal sealed class GetUserAddressListByIdAsyncHandler(
    ...
    : IRequestHandler<GetUserAddressListByIdAsyncQuery, Result<IReadOnlyCollection<AddressResponse>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return Result.Failure<IReadOnlyCollection<AddressResponse>>(GetUserByIdWithAddressListAsyncErrors.Unauthorized);
        }
        ...
        if (user == null)
        {
            return Result.Failure<IReadOnlyCollection<AddressResponse>>(GetUserByIdWithAddressListAsyncErrors.NotFound);
        }
